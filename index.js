...
var HELLO_WORLD_ANNOUNCEMENT = {
  "contents": [
    { "type": "heading",      "text": "Sunset/Sunrise Driver Loaded" },
    { "type": "paragraph",    "text": "You'll need to ensure you have an account with mashape.com and have subscribed to the geoastroapi (URL)." }
  ]
};
